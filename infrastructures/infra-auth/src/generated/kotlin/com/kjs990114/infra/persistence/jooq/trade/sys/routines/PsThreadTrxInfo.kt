...
open class PsThreadTrxInfo : AbstractRoutine<String>("ps_thread_trx_info", Sys.SYS, SQLDataType.CLOB) {
    ...
    init {
        returnParameter = PsThreadTrxInfo.RETURN_VALUE
        addInParameter(PsThreadTrxInfo.IN_THREAD_ID)
    }

    /**
     * Set the <code>in_thread_id</code> parameter IN value to the routine
     */
    fun setInThreadId(value: ULong?): Unit = setValue(PsThreadTrxInfo.IN_THREAD_ID, value)

    /**
     * Set the <code>in_thread_id</code> parameter to the function to be used
     * with a {@link org.jooq.Select} statement
     */
    fun setInThreadId(field: Field<ULong?>): PsThreadTrxInfo {
        setField(PsThreadTrxInfo.IN_THREAD_ID, field)
        return this
    }
}
