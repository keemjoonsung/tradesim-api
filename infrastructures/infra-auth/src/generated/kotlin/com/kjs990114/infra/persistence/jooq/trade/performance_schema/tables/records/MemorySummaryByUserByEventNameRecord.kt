...
open class MemorySummaryByUserByEventNameRecord() : TableRecordImpl<MemorySummaryByUserByEventNameRecord>(MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME), Record12<String?, String?, ULong?, ULong?, ULong?, ULong?, Long?, Long?, Long?, Long?, Long?, Long?> {
    ...
    override fun field1(): Field<String?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.USER
    override fun field2(): Field<String?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.EVENT_NAME
    override fun field3(): Field<ULong?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.COUNT_ALLOC
    override fun field4(): Field<ULong?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.COUNT_FREE
    override fun field5(): Field<ULong?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.SUM_NUMBER_OF_BYTES_ALLOC
    override fun field6(): Field<ULong?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.SUM_NUMBER_OF_BYTES_FREE
    override fun field7(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.LOW_COUNT_USED
    override fun field8(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.CURRENT_COUNT_USED
    override fun field9(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.HIGH_COUNT_USED
    override fun field10(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.LOW_NUMBER_OF_BYTES_USED
    override fun field11(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.CURRENT_NUMBER_OF_BYTES_USED
    override fun field12(): Field<Long?> = MemorySummaryByUserByEventName.MEMORY_SUMMARY_BY_USER_BY_EVENT_NAME.HIGH_NUMBER_OF_BYTES_USED
    ...
    override fun value1(value: String?): MemorySummaryByUserByEventNameRecord {
        set(0, value)
        return this
    }

    override fun value2(value: String?): MemorySummaryByUserByEventNameRecord {
        set(1, value)
        return this
    }

    override fun value3(value: ULong?): MemorySummaryByUserByEventNameRecord {
        set(2, value)
        return this
    }

    override fun value4(value: ULong?): MemorySummaryByUserByEventNameRecord {
        set(3, value)
        return this
    }

    override fun value5(value: ULong?): MemorySummaryByUserByEventNameRecord {
        set(4, value)
        return this
    }

    override fun value6(value: ULong?): MemorySummaryByUserByEventNameRecord {
        set(5, value)
        return this
    }

    override fun value7(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(6, value)
        return this
    }

    override fun value8(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(7, value)
        return this
    }

    override fun value9(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(8, value)
        return this
    }

    override fun value10(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(9, value)
        return this
    }

    override fun value11(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(10, value)
        return this
    }

    override fun value12(value: Long?): MemorySummaryByUserByEventNameRecord {
        set(11, value)
        return this
    }

    override fun values(value1: String?, value2: String?, value3: ULong?, value4: ULong?, value5: ULong?, value6: ULong?, value7: Long?, value8: Long?, value9: Long?, value10: Long?, value11: Long?, value12: Long?): MemorySummaryByUserByEventNameRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
