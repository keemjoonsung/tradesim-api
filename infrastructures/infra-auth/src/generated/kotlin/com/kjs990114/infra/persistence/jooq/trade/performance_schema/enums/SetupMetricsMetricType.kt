...
enum class SetupMetricsMetricType(@get:JvmName("literal") public val literal: String) : EnumType {
    `ASYNC COUNTER`("ASYNC COUNTER"),
    `ASYNC UPDOWN COUNTER`("ASYNC UPDOWN COUNTER"),
    `ASYNC GAUGE COUNTER`("ASYNC GAUGE COUNTER");
