 ...
 *    * Several sys schema views including metrics or equivalent (depending on
 ...
 * delta:
 * 
 *    * The initial view is the content of the view at the start of this
 * procedure.
 *      This output will be the same as the the start values used for the delta
 * view.
 *      The initial view is included if @sys.diagnostics.include_raw = 'ON'.
 *    * The overall view is the content of the view at the end of this
 * procedure.
 ...
 * information_schema.TABLES. This can be expensive if there
...
open class Diagnostics : AbstractRoutine<java.lang.Void>("diagnostics", Sys.SYS) {
    ...
    init {
        addInParameter(Diagnostics.IN_MAX_RUNTIME)
        addInParameter(Diagnostics.IN_INTERVAL)
        addInParameter(Diagnostics.IN_AUTO_CONFIG)
    }

    /**
     * Set the <code>in_max_runtime</code> parameter IN value to the routine
     */
    fun setInMaxRuntime(value: UInteger?): Unit = setValue(Diagnostics.IN_MAX_RUNTIME, value)

    /**
     * Set the <code>in_interval</code> parameter IN value to the routine
     */
    fun setInInterval(value: UInteger?): Unit = setValue(Diagnostics.IN_INTERVAL, value)

    /**
     * Set the <code>in_auto_config</code> parameter IN value to the routine
     */
    fun setInAutoConfig(value: String?): Unit = setValue(Diagnostics.IN_AUTO_CONFIG, value)
}
