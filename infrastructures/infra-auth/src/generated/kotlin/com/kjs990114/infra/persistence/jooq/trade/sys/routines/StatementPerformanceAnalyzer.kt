 ...
 *                     in_table can be NOW() to use a fresh snapshot. This will
 * overwrite an existing snapshot.
 *                     Use NULL for in_table to use the existing snapshot. If
 * in_table IS NULL and no snapshot
 *                     exists, a new will be created.
 *                     See also in_views and
 ...
 *                     calculating deltas.
 *     * save          Save the snapshot in the table specified by in_table. The
 * table must exists and have
 ...
 * 
 *     * snapshot      The snapshot is created based on the specified table. Set
 * to NULL or NOW() to use
 *                     the current content of
 * performance_schema.events_statements_summary_by_digest.
 ...
 * specified in @sys.statement_performance_analyzer.view to an existing view or
 * a query
 * 
 ...
 * built-in limit (e.g. the 95th percentile view).
 ...
 * --------
 * 
 * To create a report with the queries in the 95th percentile since last
 * truncate of performance_schema.events_statements_summary_by_digest
 ...
 *    7. Perform analyzis based on the delta between the initial and new
 * snapshots.
 * 
 ...
 * 
 * 
 * To create an overall report of the 95th percentile queries and the top 10
 ...
 * Query OK, 0 rows affected (0.01 sec)
 * 
 * mysql&gt; CALL sys.statement_performance_analyzer('create_table',
...
open class StatementPerformanceAnalyzer : AbstractRoutine<java.lang.Void>("statement_performance_analyzer", Sys.SYS) {
    companion object {
        ...
        /**
         * The parameter
         * <code>sys.statement_performance_analyzer.in_action</code>.
         */
        val IN_ACTION: Parameter<String?> = Internal.createParameter("in_action", SQLDataType.VARCHAR(12), false, false)

        /**
         * The parameter
         * <code>sys.statement_performance_analyzer.in_table</code>.
         */
        val IN_TABLE: Parameter<String?> = Internal.createParameter("in_table", SQLDataType.VARCHAR(129), false, false)

        /**
         * The parameter
         * <code>sys.statement_performance_analyzer.in_views</code>.
         */
        val IN_VIEWS: Parameter<String?> = Internal.createParameter("in_views", SQLDataType.VARCHAR(124), false, false)
    }

    init {
        addInParameter(StatementPerformanceAnalyzer.IN_ACTION)
        addInParameter(StatementPerformanceAnalyzer.IN_TABLE)
        addInParameter(StatementPerformanceAnalyzer.IN_VIEWS)
    }

    /**
     * Set the <code>in_action</code> parameter IN value to the routine
     */
    fun setInAction(value: String?): Unit = setValue(StatementPerformanceAnalyzer.IN_ACTION, value)

    /**
     * Set the <code>in_table</code> parameter IN value to the routine
     */
    fun setInTable(value: String?): Unit = setValue(StatementPerformanceAnalyzer.IN_TABLE, value)

    /**
     * Set the <code>in_views</code> parameter IN value to the routine
     */
    fun setInViews(value: String?): Unit = setValue(StatementPerformanceAnalyzer.IN_VIEWS, value)
}
