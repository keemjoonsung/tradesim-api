...
open class GlobalStatusRecord() : UpdatableRecordImpl<GlobalStatusRecord>(GlobalStatus.GLOBAL_STATUS), Record2<String?, String?> {
    ...
    override fun field1(): Field<String?> = GlobalStatus.GLOBAL_STATUS.VARIABLE_NAME
    override fun field2(): Field<String?> = GlobalStatus.GLOBAL_STATUS.VARIABLE_VALUE
    ...
    override fun value1(value: String?): GlobalStatusRecord {
        set(0, value)
        return this
    }

    override fun value2(value: String?): GlobalStatusRecord {
        set(1, value)
        return this
    }

    override fun values(value1: String?, value2: String?): GlobalStatusRecord {
        this.value1(value1)
        this.value2(value2)
        return this
    }
