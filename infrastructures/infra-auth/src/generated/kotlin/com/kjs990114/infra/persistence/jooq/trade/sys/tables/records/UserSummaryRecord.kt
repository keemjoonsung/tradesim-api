...
open class UserSummaryRecord() : TableRecordImpl<UserSummaryRecord>(UserSummary.USER_SUMMARY), Record12<String?, BigInteger?, String?, String?, BigInteger?, BigInteger?, String?, BigInteger?, BigInteger?, Long?, String?, String?> {
    ...
    override fun field1(): Field<String?> = UserSummary.USER_SUMMARY.USER
    override fun field2(): Field<BigInteger?> = UserSummary.USER_SUMMARY.STATEMENTS
    override fun field3(): Field<String?> = UserSummary.USER_SUMMARY.STATEMENT_LATENCY
    override fun field4(): Field<String?> = UserSummary.USER_SUMMARY.STATEMENT_AVG_LATENCY
    override fun field5(): Field<BigInteger?> = UserSummary.USER_SUMMARY.TABLE_SCANS
    override fun field6(): Field<BigInteger?> = UserSummary.USER_SUMMARY.FILE_IOS
    override fun field7(): Field<String?> = UserSummary.USER_SUMMARY.FILE_IO_LATENCY
    override fun field8(): Field<BigInteger?> = UserSummary.USER_SUMMARY.CURRENT_CONNECTIONS
    override fun field9(): Field<BigInteger?> = UserSummary.USER_SUMMARY.TOTAL_CONNECTIONS
    override fun field10(): Field<Long?> = UserSummary.USER_SUMMARY.UNIQUE_HOSTS
    override fun field11(): Field<String?> = UserSummary.USER_SUMMARY.CURRENT_MEMORY
    override fun field12(): Field<String?> = UserSummary.USER_SUMMARY.TOTAL_MEMORY_ALLOCATED
    ...
    override fun value1(value: String?): UserSummaryRecord {
        set(0, value)
        return this
    }

    override fun value2(value: BigInteger?): UserSummaryRecord {
        set(1, value)
        return this
    }

    override fun value3(value: String?): UserSummaryRecord {
        set(2, value)
        return this
    }

    override fun value4(value: String?): UserSummaryRecord {
        set(3, value)
        return this
    }

    override fun value5(value: BigInteger?): UserSummaryRecord {
        set(4, value)
        return this
    }

    override fun value6(value: BigInteger?): UserSummaryRecord {
        set(5, value)
        return this
    }

    override fun value7(value: String?): UserSummaryRecord {
        set(6, value)
        return this
    }

    override fun value8(value: BigInteger?): UserSummaryRecord {
        set(7, value)
        return this
    }

    override fun value9(value: BigInteger?): UserSummaryRecord {
        set(8, value)
        return this
    }

    override fun value10(value: Long?): UserSummaryRecord {
        set(9, value)
        return this
    }

    override fun value11(value: String?): UserSummaryRecord {
        set(10, value)
        return this
    }

    override fun value12(value: String?): UserSummaryRecord {
        set(11, value)
        return this
    }

    override fun values(value1: String?, value2: BigInteger?, value3: String?, value4: String?, value5: BigInteger?, value6: BigInteger?, value7: String?, value8: BigInteger?, value9: BigInteger?, value10: Long?, value11: String?, value12: String?): UserSummaryRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
