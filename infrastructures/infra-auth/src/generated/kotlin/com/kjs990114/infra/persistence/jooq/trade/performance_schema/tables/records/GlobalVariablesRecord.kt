...
open class GlobalVariablesRecord() : UpdatableRecordImpl<GlobalVariablesRecord>(GlobalVariables.GLOBAL_VARIABLES), Record2<String?, String?> {
    ...
    override fun field1(): Field<String?> = GlobalVariables.GLOBAL_VARIABLES.VARIABLE_NAME
    override fun field2(): Field<String?> = GlobalVariables.GLOBAL_VARIABLES.VARIABLE_VALUE
    ...
    override fun value1(value: String?): GlobalVariablesRecord {
        set(0, value)
        return this
    }

    override fun value2(value: String?): GlobalVariablesRecord {
        set(1, value)
        return this
    }

    override fun values(value1: String?, value2: String?): GlobalVariablesRecord {
        this.value1(value1)
        this.value2(value2)
        return this
    }
