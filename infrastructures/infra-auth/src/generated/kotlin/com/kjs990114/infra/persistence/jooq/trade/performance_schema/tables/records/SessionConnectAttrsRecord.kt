...
open class SessionConnectAttrsRecord() : UpdatableRecordImpl<SessionConnectAttrsRecord>(SessionConnectAttrs.SESSION_CONNECT_ATTRS), Record4<ULong?, String?, String?, Int?> {
    ...
    override fun field1(): Field<ULong?> = SessionConnectAttrs.SESSION_CONNECT_ATTRS.PROCESSLIST_ID
    override fun field2(): Field<String?> = SessionConnectAttrs.SESSION_CONNECT_ATTRS.ATTR_NAME
    override fun field3(): Field<String?> = SessionConnectAttrs.SESSION_CONNECT_ATTRS.ATTR_VALUE
    override fun field4(): Field<Int?> = SessionConnectAttrs.SESSION_CONNECT_ATTRS.ORDINAL_POSITION
    ...
    override fun value1(value: ULong?): SessionConnectAttrsRecord {
        set(0, value)
        return this
    }

    override fun value2(value: String?): SessionConnectAttrsRecord {
        set(1, value)
        return this
    }

    override fun value3(value: String?): SessionConnectAttrsRecord {
        set(2, value)
        return this
    }

    override fun value4(value: Int?): SessionConnectAttrsRecord {
        set(3, value)
        return this
    }

    override fun values(value1: ULong?, value2: String?, value3: String?, value4: Int?): SessionConnectAttrsRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
